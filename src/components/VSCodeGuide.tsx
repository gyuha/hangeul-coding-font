              ...
              <div className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
                <p>
                  ...
                  <code className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900 rounded text-xs">
                    {downloadFileName}.ttf
                  </code>{" "}
                  파일 우클릭 → "모든 사용자용으로 설치" 선택
                </p>
                <p>
                  • <strong>중요:</strong> "모든 사용자용으로 설치"를 선택해야 VSCode에서 인식됩니다
                </p>
            ...
            <div className="border border-blue-200 dark:border-blue-700 rounded-md p-3">
              ...
              <div className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
                <p>
                  • 방법 1:{" "}
                  <code className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900 rounded text-xs">
                    sudo cp {downloadFileName}.ttf /usr/share/fonts/truetype/
                  </code>
                </p>
                <p>
                  • 방법 2:{" "}
                  <code className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900 rounded text-xs">
                    mkdir -p ~/.fonts && cp {downloadFileName}.ttf ~/.fonts/
                  </code>
                </p>
                <p>
                  • 폰트 캐시 업데이트:{" "}
        ...
        <div className="border-t border-blue-200 dark:border-blue-800 pt-4">
          ...
          <div className="space-y-3">
            <div className="border-l-4 border-blue-300 pl-3">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <kbd className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900 rounded text-xs">
                  Ctrl+Shift+P
                </kbd>{" "}
          ...
          <div className="mt-4 p-3 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded">
            <p className="text-sm font-medium text-green-800 dark:text-green-200">
              💡 <strong>성공 확인 방법:</strong> VSCode 설정에서 폰트 이름 입력 시 자동완성으로
              나타나면 성공!
            </p>
          </div>
        </div>
